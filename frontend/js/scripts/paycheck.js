document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("data_rozpoczecia").value =
    urlParams.get("data_rozpoczecia") || "";

  document.getElementById("summary-rodzaj").textContent =
    document.getElementById("rodzaj").value || "-";
  document.getElementById("summary-miasto").textContent =
    document.getElementById("miasto").value || "-";
  document.getElementById("summary-okres").textContent =
