...
if (successMessage) { 
    ...
    case "1":
        successMessage.textContent = "Rejestracja przebiegła pomyślnie. Możesz się teraz zalogować.";
        showMessage();
        break;
    case "2":
        successMessage.textContent = "Hasło zostało zmienione. Możesz się teraz zalogować.";
        showMessage();
        break;
    case "3":
        successMessage.textContent = "Na podany adres email został wysłany link do zmiany hasła.";
        showMessage();
        break;
    case "4":
