document.addEventListener("DOMContentLoaded", () => {
  ...
  if (
    document.getElementById("rodzaj") === null ||
    document.getElementById("okres") === null
  ) {
  ...
  async function fetchPrice() {
    ...
    try {
      const response = await fetch(
        `../../backend/api/summary.php?rodzaj=${rodzaj}&okres=${okres}`,
      );
  ...
  if (
    rodzajSelect instanceof HTMLElement &&
    okresSelect instanceof HTMLElement
  ) {
